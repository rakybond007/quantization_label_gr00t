...
@dataclass
class FlowmatchingActionHeadMetaQConfig(PretrainedConfig):
...
class FlowmatchingActionHeadMetaQ(nn.Module):
    config_class = FlowmatchingActionHeadMetaQConfig
    supports_gradient_checkpointing = True

    def __init__(
        self,
        config: FlowmatchingActionHeadMetaQConfig,
    ):
        super().__init__()
