...
from gr00t.model.gr00t_n1_fair_moe_v3 import GR00T_N1_5_FairMoeV3
...
class Gr00tPolicyFairMoeV3(BasePolicy):
    """
    ...
    def __init__(
        ...
        """
        Initialize the Gr00tPolicyFairMoeV3.
    ...
    def _load_model(self, model_path):
        model = GR00T_N1_5_FairMoeV3.from_pretrained(model_path, torch_dtype=COMPUTE_DTYPE, backbone_model_type=self.backbone_model_type)
