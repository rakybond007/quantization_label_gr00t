...
from .action_head.flow_matching_action_head_fair_moe_v3 import (
    FlowmatchingActionHeadFairMoeV3,
    FlowmatchingActionHeadFairMoeV3Config,
)
...
# config
@dataclass
class GR00T_N1_5_FairMoeV3_Config(PretrainedConfig):
    model_type = "gr00t_n1_5_fair_moe_v3"
...
# real model
class GR00T_N1_5_FairMoeV3(PreTrainedModel):
    supports_gradient_checkpointing = True
    config_class = GR00T_N1_5_FairMoeV3_Config
    """
    ...
    def __init__(
        self,
        config: GR00T_N1_5_FairMoeV3_Config,
        ...
        action_head_cfg = FlowmatchingActionHeadFairMoeV3Config(**config.action_head_cfg)
        self.action_head = FlowmatchingActionHeadFairMoeV3(action_head_cfg)
    ...
    def from_pretrained(cls, pretrained_model_name_or_path: str, load_action_head: bool=True, **kwargs):
        ...
        if not load_action_head:
            ...
            action_head_cfg = FlowmatchingActionHeadFairMoeV3Config(**pretrained_model.config.action_head_cfg)
            pretrained_model.action_head = FlowmatchingActionHeadFairMoeV3(action_head_cfg)
...
# register
AutoConfig.register("gr00t_n1_5_fair_moe_v3", GR00T_N1_5_FairMoeV3_Config)
AutoModel.register(GR00T_N1_5_FairMoeV3_Config, GR00T_N1_5_FairMoeV3)
