...
# which loads GR00T_N1_5_MetaQV3 (with EagleBackboneMetaQ + FlowmatchingActionHeadMetaQ)
# instead of the legacy GR00T_N1_5.

from gr00t.model.policy import Gr00tPolicy, COMPUTE_DTYPE
from gr00t.model.gr00t_n1_metaq_v3 import GR00T_N1_5_MetaQV3


class Gr00tPolicyMetaQV3(Gr00tPolicy):
    ...
    that the underlying model is GR00T_N1_5_MetaQV3 which appends N learnable
    meta-query tokens to the VLM input and routes the MoE on their LM
    output features instead of vl_embeds.mean()."""

    def _load_model(self, model_path):
        model = GR00T_N1_5_MetaQV3.from_pretrained(
