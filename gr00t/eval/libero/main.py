...
def eval_libero(args: Args) -> None:
    ...
    if args.task_suite_name == "libero_spatial" or args.task_suite_name == "libero_spatial_new":
        max_steps = 220  # longest training demo has 193 steps
    elif args.task_suite_name == "libero_object":
        max_steps = 280  # longest training demo has 254 steps
    elif args.task_suite_name == "libero_goal" or args.task_suite_name == "libero_goal_new":
    ...
    result_save_path = pathlib.Path(args.video_out_path) / "results.txt"
