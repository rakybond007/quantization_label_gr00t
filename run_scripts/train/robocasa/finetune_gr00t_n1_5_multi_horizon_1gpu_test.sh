#!/bin/bash
# 1-GPU short test of multi-horizon training. Run interactively on a GPU node:
#   bash run_scripts/train/robocasa/finetune_gr00t_n1_5_multi_horizon_1gpu_test.sh
# Verifies: model loads, dataloader works, 1-step training succeeds, checkpoint saves.
...
CKPT_DIR="$BASE_DIR/ckpt/robocasa/groot/groot_n1_5_multi_horizon_1gpu_test"
