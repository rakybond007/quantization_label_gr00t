#!/bin/bash
#SBATCH --job-name=groot_n1_5_robocasa_moe4_per_expert_metaq_n32_v2_u16_c8_u24_c12_jimin_loss_full
#SBATCH --nodes=1
#SBATCH --gpus=2
#SBATCH --comment="MoE4 per_expert + meta-query N=32 + v2_u16_c8_u24_c12 decoders + full jimin-dev loss ([A][B][C] on, [D] off)"
#SBATCH --partition=sjw_alinlab
#SBATCH --output=out/%j-groot_n1_5_robocasa_metaq_n32_v2.out
#SBATCH --error=out/%j-groot_n1_5_robocasa_metaq_n32_v2.err

BASE_DIR="$HOME/multigpu_workspace/Isaac-GR00T"
CONDA_PATH="$HOME/miniconda3"
export WANDB_PROJECT=GR00T-robocasa
mkdir -p out
CKPT_DIR="$BASE_DIR/ckpt/robocasa/groot/groot_n1_5_bs64_moe4_per_expert_metaq_n32_v2"
...
python $BASE_DIR/scripts/gr00t_finetune_metaq_v2.py \
    ...
    --run-name GR00T-N1.5-robocasa-moe4-metaq-n32-v2-bs64 \
