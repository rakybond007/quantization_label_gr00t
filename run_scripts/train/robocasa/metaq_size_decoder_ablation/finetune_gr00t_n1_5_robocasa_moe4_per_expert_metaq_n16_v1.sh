#!/bin/bash
#SBATCH --job-name=groot_n1_5_robocasa_moe4_per_expert_metaq_n16_v1_u16_c8_c4_u8_jimin_loss_full
#SBATCH --nodes=1
#SBATCH --gpus=2
#SBATCH --comment="MoE4 per_expert + meta-query N=16 + v1_u16_c8_c4_u8 decoders + full jimin-dev loss ([A][B][C] on, [D] off)"
#SBATCH --partition=sjw_alinlab
#SBATCH --output=out/%j-groot_n1_5_robocasa_metaq_n16_v1.out
#SBATCH --error=out/%j-groot_n1_5_robocasa_metaq_n16_v1.err

BASE_DIR="$HOME/multigpu_workspace/Isaac-GR00T"
CONDA_PATH="$HOME/miniconda3"
export WANDB_PROJECT=GR00T-robocasa
mkdir -p out
CKPT_DIR="$BASE_DIR/ckpt/robocasa/groot/groot_n1_5_bs64_moe4_per_expert_metaq_n16_v1"
...
python $BASE_DIR/scripts/gr00t_finetune_metaq.py \
    ...
    --run-name GR00T-N1.5-robocasa-moe4-metaq-n16-v1-bs64 \
