#!/bin/bash
#SBATCH --job-name=groot_n1_5_robocasa_moe_v1_K2_raw16_merged8_b_only_no_metaq_60k_bs64
#SBATCH --nodes=1
#SBATCH --gpus=2
#SBATCH --comment="Robocasa MoE K=2 {raw16(main), merged8(m8)} ONLY (drop m4/n8) + [B] EMA-norm KL + no metaq + BALANCE ON. 2-decoder MoE ablation. fair_moe fork."
#SBATCH --partition=sjw_alinlab
#SBATCH --output=out/%j-train_robocasa_moe_v1_K2_raw16_merged8.out
#SBATCH --error=out/%j-train_robocasa_moe_v1_K2_raw16_merged8.err

BASE_DIR="$HOME/multigpu_workspace/Isaac-GR00T"
CONDA_PATH="$HOME/miniconda3"
export WANDB_PROJECT=GR00T-robocasa
mkdir -p out
CKPT_DIR="$BASE_DIR/ckpt/robocasa/groot/groot_n1_5_bs64_moe_v1_K2_raw16_merged8_b_only_no_metaq"
...
python $BASE_DIR/scripts/gr00t_finetune_fair_moe.py \
    ...
    --run-name GR00T-N1.5-robocasa-moe-K2-raw16-merged8-b-only-no-metaq-bs64 \
