#!/bin/bash
#SBATCH --job-name=groot_n1_5_robocasa_fair_moe_b_only_d_length_cost_0p10_bs64
#SBATCH --nodes=1
#SBATCH --gpus=2
#SBATCH --comment="fair_moe fork (no metaq): [B] EMA-norm KL + [D] length cost γ=0.10 in EMA-normalized units."
#SBATCH --partition=sjw_alinlab
#SBATCH --output=out/%j-groot_n1_5_robocasa_fair_moe_b_d_lc_0p10.out
#SBATCH --error=out/%j-groot_n1_5_robocasa_fair_moe_b_d_lc_0p10.err

BASE_DIR="$HOME/multigpu_workspace/Isaac-GR00T"
CONDA_PATH="$HOME/miniconda3"
export WANDB_PROJECT=GR00T-robocasa
mkdir -p out
CKPT_DIR="$BASE_DIR/ckpt/robocasa/groot/groot_n1_5_bs64_fair_moe_b_d_lc_0p10"
...
python $BASE_DIR/scripts/gr00t_finetune_fair_moe.py \
    ...
    --run-name GR00T-N1.5-robocasa-fair-moe-b-d-lc-0p10-bs64 \
