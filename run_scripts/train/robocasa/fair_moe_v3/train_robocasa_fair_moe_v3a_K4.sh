#!/bin/bash
#SBATCH --job-name=groot_n1_5_robocasa_fair_moe_v3a_u32_c16_u16_c8_K4_B_only_no_metaq_60k_bs64
#SBATCH --nodes=1
#SBATCH --gpus=2
#SBATCH --comment="fair_moe v3a (K=4): decoders {u32, c16-from-32, u16, c8-from-16}. [B] EMA-norm KL only. No metaq."
#SBATCH --partition=sjw_alinlab
#SBATCH --output=out/%j-train_robocasa_fair_moe_v3a_K4.out
#SBATCH --error=out/%j-train_robocasa_fair_moe_v3a_K4.err

BASE_DIR="$HOME/multigpu_workspace/Isaac-GR00T"
CONDA_PATH="$HOME/miniconda3"
export WANDB_PROJECT=GR00T-robocasa
mkdir -p out
CKPT_DIR="$BASE_DIR/ckpt/robocasa/groot/groot_n1_5_bs64_fair_moe_v3a_b_only"
...
python $BASE_DIR/scripts/gr00t_finetune_fair_moe_v3.py \
    ...
    --run-name GR00T-N1.5-robocasa-fair-moe-v3a-K4-b-only-bs64 \
