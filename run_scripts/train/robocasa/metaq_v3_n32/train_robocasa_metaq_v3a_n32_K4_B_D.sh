#!/bin/bash
#SBATCH --job-name=groot_n1_5_robocasa_metaq_v3a_n32_u32_c16_u16_c8_K4_B_D_lc_0p10_metaq32_60k_bs64
#SBATCH --nodes=1
#SBATCH --gpus=2
#SBATCH --comment="metaq v3a (K=4) + n_meta_q=32 + [B] EMA-norm KL + [D] length cost gamma=0.10."
#SBATCH --partition=sjw_alinlab
#SBATCH --output=out/%j-train_robocasa_metaq_v3a_n32_K4_B_D.out
#SBATCH --error=out/%j-train_robocasa_metaq_v3a_n32_K4_B_D.err

BASE_DIR="$HOME/multigpu_workspace/Isaac-GR00T"
CONDA_PATH="$HOME/miniconda3"
export WANDB_PROJECT=GR00T-robocasa
mkdir -p out
CKPT_DIR="$BASE_DIR/ckpt/robocasa/groot/groot_n1_5_bs64_metaq_v3a_n32_b_d_lc_0p10"
...
python $BASE_DIR/scripts/gr00t_finetune_metaq_v3.py \
    ...
    --run-name GR00T-N1.5-robocasa-metaq-v3a-n32-K4-b-d-lc-0p10-bs64 \
