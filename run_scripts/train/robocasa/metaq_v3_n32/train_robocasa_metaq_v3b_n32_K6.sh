#!/bin/bash
#SBATCH --job-name=groot_n1_5_robocasa_metaq_v3b_n32_u32_c16_u16_c8_u8_c4_K6_B_only_metaq32_60k_bs64
#SBATCH --nodes=1
#SBATCH --gpus=2
#SBATCH --comment="metaq v3b (K=6): decoders {u32, c16-from-32, u16, c8-from-16, u8, c4-from-8}, n_meta_q=32. [B] EMA-norm KL only."
#SBATCH --partition=sjw_alinlab
#SBATCH --output=out/%j-train_robocasa_metaq_v3b_n32_K6.out
#SBATCH --error=out/%j-train_robocasa_metaq_v3b_n32_K6.err

BASE_DIR="$HOME/multigpu_workspace/Isaac-GR00T"
CONDA_PATH="$HOME/miniconda3"
export WANDB_PROJECT=GR00T-robocasa
mkdir -p out
CKPT_DIR="$BASE_DIR/ckpt/robocasa/groot/groot_n1_5_bs64_metaq_v3b_n32_b_only"
...
python $BASE_DIR/scripts/gr00t_finetune_metaq_v3.py \
    ...
    --run-name GR00T-N1.5-robocasa-metaq-v3b-n32-K6-b-only-bs64 \
