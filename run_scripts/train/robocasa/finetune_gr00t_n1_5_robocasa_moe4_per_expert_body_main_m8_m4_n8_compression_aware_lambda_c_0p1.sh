#!/bin/bash
#SBATCH --job-name=groot_n1_5_robocasa_moe4_per_expert_body_main_m8_m4_n8_compression_aware_lambda_c_0p1_router_prior
#SBATCH --nodes=1
#SBATCH --gpus=2
#SBATCH --comment="GR00T N1.5 finetune on robocasa: 4-expert MoE (main+m8+m4+n8) + compression-aware router prior (lambda_c=0.1)"
#SBATCH --partition=sjw_alinlab
#SBATCH --output=out/%j-groot_n1_5_robocasa_moe4_compaware.out
#SBATCH --error=out/%j-groot_n1_5_robocasa_moe4_compaware.err

BASE_DIR="$HOME/multigpu_workspace/Isaac-GR00T"
CONDA_PATH="$HOME/miniconda3"
export WANDB_PROJECT=GR00T-robocasa
mkdir -p out
CKPT_DIR="$BASE_DIR/ckpt/robocasa/groot/groot_n1_5_bs64_moe4_per_expert_body_compression_aware_lambda_c_0p1"
...
python $BASE_DIR/scripts/gr00t_finetune.py \
    ...
    --run-name GR00T-N1.5-robocasa-moe4-compression-aware-lambda-c-0p1-bs64 \
