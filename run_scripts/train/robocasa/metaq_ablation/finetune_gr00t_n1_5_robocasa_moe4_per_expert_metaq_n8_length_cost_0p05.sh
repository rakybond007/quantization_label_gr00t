#!/bin/bash
#SBATCH --job-name=groot_n1_5_robocasa_moe4_per_expert_metaq_n8_ablation_length_cost_0p05_lc=0.05_softer_compression_push
#SBATCH --nodes=1
#SBATCH --gpus=2
#SBATCH --comment="Metaq ablation: lc=0.05_softer_compression_push"
#SBATCH --partition=sjw_alinlab
#SBATCH --output=out/%j-groot_n1_5_robocasa_metaq_length_cost_0p05.out
#SBATCH --error=out/%j-groot_n1_5_robocasa_metaq_length_cost_0p05.err

BASE_DIR="$HOME/multigpu_workspace/Isaac-GR00T"
CONDA_PATH="$HOME/miniconda3"
export WANDB_PROJECT=GR00T-robocasa
mkdir -p out
CKPT_DIR="$BASE_DIR/ckpt/robocasa/groot/groot_n1_5_bs64_moe4_per_expert_metaq_n8_length_cost_0p05"
...
python $BASE_DIR/scripts/gr00t_finetune_metaq.py \
    ...
    --run-name GR00T-N1.5-robocasa-moe4-metaq-n8-length_cost_0p05-bs64 \
    ...
    --n-meta-q=8 --moe-shared-t --moe-normalize-loss-for-kl --moe-loss-ema-momentum=0.99 --moe-balance-type=switch --moe-length-cost-weight=0.05
