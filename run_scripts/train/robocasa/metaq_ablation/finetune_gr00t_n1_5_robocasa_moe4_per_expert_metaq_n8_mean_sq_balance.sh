#!/bin/bash
#SBATCH --job-name=groot_n1_5_robocasa_moe4_per_expert_metaq_n8_ablation_mean_sq_balance_drop_C_mean_sq_balance_lc=0.10
#SBATCH --nodes=1
#SBATCH --gpus=2
#SBATCH --comment="Metaq ablation: drop_C_mean_sq_balance_lc=0.10"
#SBATCH --partition=sjw_alinlab
#SBATCH --output=out/%j-groot_n1_5_robocasa_metaq_mean_sq_balance.out
#SBATCH --error=out/%j-groot_n1_5_robocasa_metaq_mean_sq_balance.err

BASE_DIR="$HOME/multigpu_workspace/Isaac-GR00T"
CONDA_PATH="$HOME/miniconda3"
export WANDB_PROJECT=GR00T-robocasa
mkdir -p out
CKPT_DIR="$BASE_DIR/ckpt/robocasa/groot/groot_n1_5_bs64_moe4_per_expert_metaq_n8_mean_sq_balance"
...
python $BASE_DIR/scripts/gr00t_finetune_metaq.py \
    ...
    --run-name GR00T-N1.5-robocasa-moe4-metaq-n8-mean_sq_balance-bs64 \
    ...
    --n-meta-q=8 --moe-shared-t --moe-normalize-loss-for-kl --moe-loss-ema-momentum=0.99 --moe-balance-type=mean_sq --moe-length-cost-weight=0.10
