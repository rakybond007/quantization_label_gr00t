#!/bin/bash
#SBATCH --job-name=groot_n1_5_robocasa_moe4_per_expert_metaq_n8_ablation_n_meta_q_16_n_meta_q=16_more_router_capacity_lc=0.10
#SBATCH --nodes=1
#SBATCH --gpus=2
#SBATCH --comment="Metaq ablation: n_meta_q=16_more_router_capacity_lc=0.10"
#SBATCH --partition=sjw_alinlab
#SBATCH --output=out/%j-groot_n1_5_robocasa_metaq_n_meta_q_16.out
#SBATCH --error=out/%j-groot_n1_5_robocasa_metaq_n_meta_q_16.err

BASE_DIR="$HOME/multigpu_workspace/Isaac-GR00T"
CONDA_PATH="$HOME/miniconda3"
export WANDB_PROJECT=GR00T-robocasa
mkdir -p out
CKPT_DIR="$BASE_DIR/ckpt/robocasa/groot/groot_n1_5_bs64_moe4_per_expert_metaq_n8_n_meta_q_16"
...
python $BASE_DIR/scripts/gr00t_finetune_metaq.py \
    ...
    --run-name GR00T-N1.5-robocasa-moe4-metaq-n8-n_meta_q_16-bs64 \
    ...
    --n-meta-q=16 --moe-shared-t --moe-normalize-loss-for-kl --moe-loss-ema-momentum=0.99 --moe-balance-type=switch --moe-length-cost-weight=0.10
