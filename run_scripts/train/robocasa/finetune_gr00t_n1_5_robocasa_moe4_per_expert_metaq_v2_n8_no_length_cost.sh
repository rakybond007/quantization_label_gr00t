#!/bin/bash
#SBATCH --job-name=groot_n1_5_robocasa_moe4_per_expert_metaq_v2_u16_c8_u24_c12_n8_no_length_cost
#SBATCH --nodes=1
#SBATCH --gpus=2
#SBATCH --comment="V2 decoders u16/c8/u24/c12 (16- and 24-coverage) + meta-query N=8 + [A] shared_t + [B] EMA-norm KL + [C] switch balance.  No [D] length cost."
#SBATCH --partition=sjw_alinlab
#SBATCH --output=out/%j-groot_n1_5_robocasa_metaq_v2_no_d.out
#SBATCH --error=out/%j-groot_n1_5_robocasa_metaq_v2_no_d.err

BASE_DIR="$HOME/multigpu_workspace/Isaac-GR00T"
CONDA_PATH="$HOME/miniconda3"
export WANDB_PROJECT=GR00T-robocasa
mkdir -p out
CKPT_DIR="$BASE_DIR/ckpt/robocasa/groot/groot_n1_5_bs64_moe4_per_expert_metaq_v2_n8_no_length_cost"
...
python $BASE_DIR/scripts/gr00t_finetune_metaq_v2.py \
    ...
    --run-name GR00T-N1.5-robocasa-moe4-metaq-v2-n8-no-length-cost-bs64 \
