#!/bin/bash
#SBATCH --job-name=groot_n1_5_libero_moe_per_quad_mask_4_quads_3_options_main_m8_m4_dynamic_chunking
#SBATCH --nodes=1
#SBATCH --gpus=2
#SBATCH --comment="GR00T N1.5 finetune on libero: per-quad mask MoE routing (4 quads × 3 options main/m8/m4, n8 unused)"
#SBATCH --partition=sjw_alinlab
#SBATCH --output=out/%j-groot_n1_5_libero_moe_per_quad_mask.out
#SBATCH --error=out/%j-groot_n1_5_libero_moe_per_quad_mask.err
...
CKPT_DIR="$BASE_DIR/ckpt/libero/groot/groot_n1_5_bs64_moe_per_quad_mask_4q3o_main_m8_m4"
...
python $BASE_DIR/scripts/gr00t_finetune.py \
    ...
    --run-name GR00T-N1.5-libero-moe-per-quad-mask-4q3o-bs64 \
    --batch-size 32 \
    --num-gpus 2 \
    --max-steps 60000 \
    --save-steps 10000 \
