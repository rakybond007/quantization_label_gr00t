#!/bin/bash
#SBATCH --job-name=groot_n1_5_libero_expert_scratch
#SBATCH --nodes=1
#SBATCH --gpus=2
#SBATCH --partition=batch
#SBATCH --comment="Finetune GR00T N1.5 with libero dataset using expert scratch"
...
CKPT_DIR="$BASE_DIR/ckpt/groot/groot_n1_5_libero_expert_scratch"
...
python $BASE_DIR/Isaac-GR00T/scripts/gr00t_finetune.py \
    ...
    --run-name "GR00T-N1.5-libero-expert-scratch" \
    --num-gpus 2 \
    --batch-size 16 \
    --max-steps 60000 \
    --save-steps 5000 \
