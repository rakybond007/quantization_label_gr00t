#!/bin/bash
#SBATCH --job-name=groot_n1_5_libero_moe4_per_expert_body_length_cost_gamma_0p02
#SBATCH --nodes=1
#SBATCH --gpus=2
#SBATCH --comment="GR00T N1.5 libero: MoE4 (main+m8+m4+n8) + joint quality+length objective (gamma=0.02)"
#SBATCH --partition=sjw_alinlab
#SBATCH --output=out/%j-groot_n1_5_libero_moe4_lengthcost.out
#SBATCH --error=out/%j-groot_n1_5_libero_moe4_lengthcost.err

BASE_DIR="$HOME/multigpu_workspace/Isaac-GR00T"
CONDA_PATH="$HOME/miniconda3"
export WANDB_PROJECT=GR00T-libero
mkdir -p out
CKPT_DIR="$BASE_DIR/ckpt/libero/groot/groot_n1_5_bs64_moe4_per_expert_body_length_cost_gamma_0p02"
...
python $BASE_DIR/scripts/gr00t_finetune.py \
    ...
    --run-name GR00T-N1.5-libero-moe4-length-cost-gamma-0p02-bs64 \
