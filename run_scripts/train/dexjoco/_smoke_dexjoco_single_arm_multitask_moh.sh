...
# 2 GPU per-gpu batch 32 (global 64), 10 steps. Verify MoH wiring on dexjoco.
set -u
BASE_DIR="$HOME/multigpu_workspace/Isaac-GR00T"
CONDA_PATH="$HOME/miniconda3"
CKPT_DIR="$BASE_DIR/ckpt/_smoke_dexjoco_single_arm_multitask_moh"
mkdir -p out
...
$CONDA_PATH/envs/gr00t/bin/python $BASE_DIR/scripts/gr00t_finetune_moh.py \
    ...
    --batch-size 32 --num-gpus 2 --max-steps 10 --save-steps 1000 \
    --report-to wandb \
    --horizons 4 8 12 16 \
    --aux-weight 1.0 \
