#!/bin/bash
#SBATCH --job-name=groot_n1_5_dexjoco_single_arm_multitask_6tasks_moe4_v1_balance_60k_bs64_2gpu
#SBATCH --nodes=1
#SBATCH --gpus=2
...
CKPT_DIR="$BASE_DIR/ckpt/dexjoco/groot/groot_n1_5_bs64_single_arm_multitask_moe4_v1_balance"
...
python $BASE_DIR/scripts/gr00t_finetune_fair_moe.py \
    ...
    --run-name GR00T-N1.5-dexjoco-single-arm-multitask-moe4-v1-balance-bs64 \
