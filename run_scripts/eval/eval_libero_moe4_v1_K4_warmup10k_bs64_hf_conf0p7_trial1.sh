#!/bin/bash
#SBATCH --job-name=eval_libero_moe4_v1_K4_b_only_no_metaq_HF_60k_conf0p7_gated_stochastic_trial1_4suite_10arr
#SBATCH --nodes=1
#SBATCH --gpus=1
...
#SBATCH --comment="libero MoE4 v1 (K=4 u16/c8/c4/n8) + B only + warmup=10k bs64 HF @60k, STOCHASTIC router pick, all 4 suites."

set -u
HF_REPO=prehj/GR00T-N1.5-libero-moe4-v1-K4-b-only-no-metaq-warmup10k-bs64-60k
PORT=$((9300 + SLURM_ARRAY_TASK_ID))
...
OUTPUT_BASE="$BASE_DIR/output/libero/moe4_v1_K4_warmup10k_bs64_hf_conf0p7_trial1"
