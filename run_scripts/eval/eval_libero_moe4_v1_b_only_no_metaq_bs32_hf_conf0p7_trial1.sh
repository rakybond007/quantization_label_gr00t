#!/bin/bash
#SBATCH --job-name=eval_libero_moe4_v1_b_only_no_metaq_bs32_HF_60k_conf0p7_gated_trial1_4suite_10arr
#SBATCH --nodes=1
#SBATCH --gpus=1
...
OUTPUT_BASE="$BASE_DIR/output/libero/moe4_v1_b_only_no_metaq_bs32_hf_conf0p7_trial1"
