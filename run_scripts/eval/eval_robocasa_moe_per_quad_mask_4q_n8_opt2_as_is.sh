#!/bin/bash
#SBATCH --job-name=eval_robocasa_moe_per_quad_mask_4q_n8_opt2_as_is_60k_chkpt
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --partition=background
#SBATCH --array=0-7
#SBATCH --output=out/%A_%a-eval_robocasa_pqm_n8_opt2.out
#SBATCH --error=out/%A_%a-eval_robocasa_pqm_n8_opt2.err
#SBATCH --time=2-00:00:00
#SBATCH --comment="Robocasa MoE4 per_quad+u8 ablation opt2 eval at checkpoint-60000"
...
CKPT="$BASE_DIR/ckpt/robocasa/groot/groot_n1_5_bs64_moe_pqm_4q_n8_opt2_balanced/checkpoint-60000"
OUTPUT_BASE="$BASE_DIR/output/robocasa/moe_per_quad_mask_4q_n8_opt2_as_is"
