#!/bin/bash
#SBATCH --job-name=eval_dexjoco_single_arm_multitask_moe4_v1_no_balance_60k_stochastic_50ep_arr6
#SBATCH --nodes=1
#SBATCH --gpus=1
...
#SBATCH --time=4:00:00
#SBATCH --comment="DexJoCo 6-task MoE4 v1 (no balance) STOCHASTIC router pick (head=moe + --moe-stochastic) @60k, 50 ep/task. Sample expert by trained router probs instead of argmax — tests soft-prob distribution behavior."
...
OUTPUT_BASE="$BASE_DIR/output/dexjoco/single_arm_multitask_moe4_v1_no_balance_60k_stochastic"
