#!/bin/bash
#SBATCH --job-name=eval_libero_baseline_bs32_HF_60k_naive_quantize_K3_4suite_10arr_50ep
#SBATCH --nodes=1
#SBATCH --gpus=1
...
OUTPUT_BASE="$BASE_DIR/output/libero/baseline_bs32_hf_quantize_K3"
...
for TASK_NAME in "${TASK_NAMES[@]}"; do
    ...
    mkdir -p "$OUTPUT_DIR"
    PYTHONPATH="$HOME/multigpu_workspace/openpi/packages/openpi-client/src" "$CONDA_PATH/envs/libero/bin/python" "$BASE_DIR/gr00t/eval/libero/eval_taskwise_gr00t_quantize.py" \
