#!/bin/bash
#SBATCH --job-name=eval_robocasa_moe_per_quad_mask_4q_n8_opt1plus_as_is_60k_chkpt
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --partition=background
#SBATCH --array=0-7
#SBATCH --output=out/%A_%a-eval_robocasa_pqm_n8_opt1plus.out
#SBATCH --error=out/%A_%a-eval_robocasa_pqm_n8_opt1plus.err
#SBATCH --time=2-00:00:00
#SBATCH --comment="Robocasa MoE4 per_quad+u8 ablation opt1plus eval at checkpoint-60000"

set -u
PORT=$((9930 + SLURM_ARRAY_TASK_ID))
N_EPISODES=50

BASE_DIR="$HOME/multigpu_workspace/Isaac-GR00T"
CONDA_PATH="$HOME/miniconda3"
CKPT="$BASE_DIR/ckpt/robocasa/groot/groot_n1_5_bs64_moe_pqm_4q_n8_opt1plus_router512_temp0p3/checkpoint-60000"
OUTPUT_BASE="$BASE_DIR/output/robocasa/moe_per_quad_mask_4q_n8_opt1plus_as_is"
