#!/bin/bash
#SBATCH --job-name=eval_libero_moe4_v1_K4_b_only_no_metaq_router_instr_end_bs32_HF_60k_as_is_4suite_10arr_50ep
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --partition=background
#SBATCH --array=0-9
#SBATCH --output=out/%A_%a-eval_libero_moe4_v1_router_instr_end_bs32.out
#SBATCH --error=out/%A_%a-eval_libero_moe4_v1_router_instr_end_bs32.err
#SBATCH --time=1-00:00:00
#SBATCH --comment="libero MoE4 v1 (K=4 u16/c8/c4/n8) + B only + no metaq, ROUTER INPUT=instruction_end, bs32 HF ckpt @60k, as_is router pick, all 4 suites."

set -u
HF_REPO=prehj/GR00T-N1.5-libero-moe4-v1-K4-b-only-no-metaq-router-instr-end-bs32-60k
PORT=$((9550 + SLURM_ARRAY_TASK_ID))
...
OUTPUT_BASE="$BASE_DIR/output/libero/moe4_v1_b_only_no_metaq_router_instr_end_bs32_hf_as_is"
