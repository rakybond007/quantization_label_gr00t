#!/bin/bash
#SBATCH --job-name=eval_robocasa_moe4_zscore_critic_lc_0p3_as_is_60k_chkpt
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --partition=background
#SBATCH --array=0-7
#SBATCH --output=out/%A_%a-eval_robocasa_moe4_zscore.out
#SBATCH --error=out/%A_%a-eval_robocasa_moe4_zscore.err
#SBATCH --time=2-00:00:00
#SBATCH --comment="Robocasa MoE4 (main+m8+m4+n8) z-score critic + length cost γ=0.3 σ-units — as_is eval at checkpoint-60000"
...
CKPT="$BASE_DIR/ckpt/robocasa/groot/groot_n1_5_bs64_moe4_per_expert_body_zscore_critic_lc_0p3/checkpoint-60000"
OUTPUT_BASE="$BASE_DIR/output/robocasa/moe4_zscore_critic_lc_0p3_as_is"
...
echo "[i] Array $SLURM_ARRAY_TASK_ID | MoE4 z-score+critic+lc as_is | ckpt-60000 | port=$PORT"
