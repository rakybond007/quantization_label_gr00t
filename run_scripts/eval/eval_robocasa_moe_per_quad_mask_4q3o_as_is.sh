#!/bin/bash
#SBATCH --job-name=eval_robocasa_moe_per_quad_mask_4q3o_main_m8_m4_as_is_60k_chkpt
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --partition=background
#SBATCH --array=0-7
#SBATCH --output=out/%A_%a-eval_robocasa_per_quad_mask_60k.out
#SBATCH --error=out/%A_%a-eval_robocasa_per_quad_mask_60k.err
#SBATCH --time=2-00:00:00
#SBATCH --comment="Robocasa MoE per_quad_mask 4-quad × 3-option (main/m8/m4) — checkpoint-60000 (canonical)"
...
CKPT="$BASE_DIR/ckpt/robocasa/groot/groot_n1_5_bs64_moe_per_quad_mask_4q3o_main_m8_m4/checkpoint-60000"
OUTPUT_BASE="$BASE_DIR/output/robocasa/moe_per_quad_mask_4q3o_as_is"
...
echo "[i] Array $SLURM_ARRAY_TASK_ID | per_quad_mask as_is | ckpt-60000 | port=$PORT"
