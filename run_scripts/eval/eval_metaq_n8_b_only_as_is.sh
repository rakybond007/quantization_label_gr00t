#!/bin/bash
#SBATCH --job-name=eval_robocasa_metaq_n8_b_only_60k_chkpt_as_is_router_pick_24t_50ep_arr8_local_ckpt
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --partition=background
#SBATCH --array=0-7
#SBATCH --output=out/%A_%a-eval_robocasa_metaq_n8_b_only_as_is.out
#SBATCH --error=out/%A_%a-eval_robocasa_metaq_n8_b_only_as_is.err
#SBATCH --time=2-00:00:00
#SBATCH --comment="metaq + [B] EMA-norm KL only (local 318766) eval at 60k, as_is router pick."
