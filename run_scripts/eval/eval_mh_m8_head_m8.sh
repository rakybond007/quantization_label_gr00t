#!/bin/bash
#SBATCH --job-name=eval_mh_m8_m8
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --comment="m8 model (no consist) eval with m8 head (native 8-step compressed)"
#SBATCH --partition=background
#SBATCH --array=0-7
#SBATCH --output=out/%A_%a-eval_mh_m8_m8.out
#SBATCH --error=out/%A_%a-eval_mh_m8_m8.err
...
echo "[i] Array $SLURM_ARRAY_TASK_ID | mh_m8 m8 head | port=$PORT"
