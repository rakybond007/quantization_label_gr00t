#!/bin/bash
#SBATCH --job-name=eval_robocasa_moe3_compaware_lambda_c_0p1_as_is_60k_chkpt
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --partition=background
#SBATCH --array=0-7
#SBATCH --output=out/%A_%a-eval_robocasa_moe3_compaware_as_is.out
#SBATCH --error=out/%A_%a-eval_robocasa_moe3_compaware_as_is.err
#SBATCH --time=2-00:00:00
#SBATCH --comment="Robocasa MoE3 (main+m8+m4) compression-aware lambda_c=0.1 — as_is eval"
...
CKPT="$BASE_DIR/ckpt/robocasa/groot/groot_n1_5_bs64_moe3_per_expert_body_compression_aware_lambda_c_0p1/checkpoint-60000"
OUTPUT_BASE="$BASE_DIR/output/robocasa/moe3_compaware_lambda_c_0p1_as_is"
...
echo "[i] Array $SLURM_ARRAY_TASK_ID | MoE3 compaware as_is | port=$PORT"
