#!/bin/bash
#SBATCH --job-name=eval_robocasa_jimin_moe4_abl_emaKL_60k_ckpt_repro_with_our_pipeline_24t_50ep_arr8
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --partition=background
#SBATCH --array=0-7
#SBATCH --output=out/%A_%a-eval_robocasa_jimin_moe4_abl_emaKL_repro.out
#SBATCH --error=out/%A_%a-eval_robocasa_jimin_moe4_abl_emaKL_repro.err
#SBATCH --time=2-00:00:00
#SBATCH --comment="Reproduce jimin's moe4_abl_emaKL eval using our inference_service.py + robocasa_service_moe.py."
...
OUTPUT_BASE="$BASE_DIR/output/robocasa/jimin_moe4_abl_emaKL_60k_repro"
