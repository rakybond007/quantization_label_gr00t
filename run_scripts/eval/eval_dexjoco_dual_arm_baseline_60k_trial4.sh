#!/bin/bash
#SBATCH --job-name=eval_dexjoco_dual_arm_5tasks_baseline_60k_50ep_arr5_trial4_seed42
#SBATCH --nodes=1
#SBATCH --gpus=1
...
OUTPUT_BASE="$BASE_DIR/output/dexjoco/dual_arm_multitask_baseline_60k_trial4"
