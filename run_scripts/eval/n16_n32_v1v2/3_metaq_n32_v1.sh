#!/bin/bash
#SBATCH --job-name=eval_robocasa_metaq_n32_v1_as_is_60k_chkpt_24t_50ep_arr8_HFckpt
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --partition=background
#SBATCH --array=0-7
#SBATCH --output=out/%A_%a-eval_robocasa_metaq_n32_v1.out
#SBATCH --error=out/%A_%a-eval_robocasa_metaq_n32_v1.err
#SBATCH --time=2-00:00:00
#SBATCH --comment="HF metaq_n32_v1 eval (prehj/gr00t-n1.5-robocasa-metaq-n32-v1)"

set -u
PORT=$((9530 + SLURM_ARRAY_TASK_ID))
N_EPISODES=50

BASE_DIR="$HOME/multigpu_workspace/Isaac-GR00T"
CONDA_PATH="$HOME/miniconda3"
CKPT="$("$CONDA_PATH/envs/gr00t/bin/python" -c "from huggingface_hub import snapshot_download; print(snapshot_download('prehj/gr00t-n1.5-robocasa-metaq-n32-v1', repo_type='model'))")"
OUTPUT_BASE="$BASE_DIR/output/robocasa/moe4_per_expert_metaq_n32_v1_as_is"
