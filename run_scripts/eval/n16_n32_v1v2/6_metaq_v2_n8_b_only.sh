#!/bin/bash
#SBATCH --job-name=eval_robocasa_metaq_v2_n8_b_only_as_is_60k_chkpt_24t_50ep_arr8_HFckpt
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --partition=background
#SBATCH --array=0-7
#SBATCH --output=out/%A_%a-eval_robocasa_metaq_v2_n8_b_only.out
#SBATCH --error=out/%A_%a-eval_robocasa_metaq_v2_n8_b_only.err
#SBATCH --time=2-00:00:00
#SBATCH --comment="HF metaq_v2_n8_b_only eval (prehj/gr00t-n1.5-robocasa-metaq-v2-n8-b-only)"
