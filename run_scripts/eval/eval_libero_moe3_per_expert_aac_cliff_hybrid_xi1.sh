#!/bin/bash
#SBATCH --job-name=eval_libero_moe3_per_expert_main_m8_m4_with_aac_cliff_hybrid_entropy_self_agree_alpha0p5_xi1_60k_chkpt
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --partition=background
#SBATCH --array=0-9
#SBATCH --output=out/%A_%a-eval_libero_moe3_aac_cliff_hybrid_xi1.out
#SBATCH --error=out/%A_%a-eval_libero_moe3_aac_cliff_hybrid_xi1.err
#SBATCH --time=1-00:00:00
#SBATCH --comment="Libero MoE3 + aac_cliff_hybrid (entropy + self_agree, alpha=0.5, xi=1)"

set -u
HEAD=moe_selective; N=10; MODE=aac_cliff_hybrid; AAC_XI=1
PORT=$((9000 + 960 + SLURM_ARRAY_TASK_ID))
