#!/bin/bash
#SBATCH --job-name=eval_libero_moe4_v1_K4_b_only_no_metaq_HF_60k_conf0p7_gated_stochastic_trial2_4suite_10arr
#SBATCH --nodes=1
#SBATCH --gpus=1
...
OUTPUT_BASE="$BASE_DIR/output/libero/moe4_v1_K4_warmup10k_bs64_hf_conf0p7_trial2"
