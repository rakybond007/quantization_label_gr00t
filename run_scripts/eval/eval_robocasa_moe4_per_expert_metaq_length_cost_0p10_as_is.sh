#!/bin/bash
#SBATCH --job-name=eval_robocasa_moe4_per_expert_metaq_length_cost_0p10_as_is_60k_chkpt
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --partition=background
#SBATCH --array=0-7
#SBATCH --output=out/%A_%a-eval_robocasa_metaq_length_cost_0p10.out
#SBATCH --error=out/%A_%a-eval_robocasa_metaq_length_cost_0p10.err
#SBATCH --time=2-00:00:00
#SBATCH --comment="Metaq length_cost_0p10 eval at checkpoint-60000"

set -u
PORT=$((9410 + SLURM_ARRAY_TASK_ID))
N_EPISODES=50

BASE_DIR="$HOME/multigpu_workspace/Isaac-GR00T"
CONDA_PATH="$HOME/miniconda3"
CKPT="$BASE_DIR/ckpt/robocasa/groot/groot_n1_5_bs64_moe4_per_expert_metaq_n8_length_cost_0p10/checkpoint-60000"
OUTPUT_BASE="$BASE_DIR/output/robocasa/moe4_per_expert_metaq_length_cost_0p10_as_is"
