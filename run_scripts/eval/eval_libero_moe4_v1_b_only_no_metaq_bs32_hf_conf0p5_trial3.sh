#!/bin/bash
#SBATCH --job-name=eval_libero_moe4_v1_b_only_no_metaq_bs32_HF_60k_conf0p5_gated_trial3_4suite_10arr
#SBATCH --nodes=1
#SBATCH --gpus=1
...
OUTPUT_BASE="$BASE_DIR/output/libero/moe4_v1_b_only_no_metaq_bs32_hf_conf0p5_trial3"
...
"$CONDA_PATH/envs/gr00t/bin/python" "$BASE_DIR/scripts/serve_policy_fair_moe.py" \
    --port=$PORT --model-path=$CKPT --head=moe --n-samples=1 --moe-stochastic --moe-confidence-threshold 0.5 \
