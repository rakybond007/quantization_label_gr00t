#!/bin/bash
#SBATCH --job-name=eval_dexjoco_single_arm_baseline_30k_compress_K3_6t_50ep_arr6
#SBATCH --nodes=1
#SBATCH --gpus=1
...
OUTPUT_BASE="$BASE_DIR/output/dexjoco/single_arm_multitask_baseline_30k_compress_K3"
