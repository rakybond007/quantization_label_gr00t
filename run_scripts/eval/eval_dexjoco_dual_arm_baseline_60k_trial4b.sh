#!/bin/bash
#SBATCH --job-name=eval_dexjoco_dual_arm_5tasks_baseline_60k_50ep_arr5_trial4b_seed42
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --partition=background
#SBATCH --exclude=worker-node100
#SBATCH --array=0-4
#SBATCH --output=out/%A_%a-eval_dexjoco_dual_arm_baseline_60k_trial4.out
#SBATCH --error=out/%A_%a-eval_dexjoco_dual_arm_baseline_60k_trial4.err
#SBATCH --comment="DexJoCo dual-arm 5-task baseline GR00T-N1.5 @60k, 50 ep/task."
...
CKPT="$BASE_DIR/ckpt/dexjoco/groot/groot_n1_5_bs64_dual_arm_multitask_baseline/checkpoint-60000"
CONFIG="$DEXJOCO_REPO/configs/rand_obj/$TASK.yaml"
OUTPUT_BASE="$BASE_DIR/output/dexjoco/dual_arm_multitask_baseline_60k_trial4b"
