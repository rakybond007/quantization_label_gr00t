#!/bin/bash
#SBATCH --job-name=eval_dexjoco_single_arm_multitask_6tasks_baseline_60k_rerun_50ep_arr6
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --partition=background
#SBATCH --exclude=worker-node100
#SBATCH --array=0-5
#SBATCH --output=out/%A_%a-eval_dexjoco_single_arm_baseline_rerun.out
#SBATCH --error=out/%A_%a-eval_dexjoco_single_arm_baseline_rerun.err
#SBATCH --time=4:00:00
#SBATCH --comment="DexJoCo single-arm 6-task baseline GR00T-N1.5 @60k, 50 ep/task. RERUN for sanity (different seed/rollout)."
...
OUTPUT_BASE="$BASE_DIR/output/dexjoco/single_arm_multitask_baseline_60k_rerun"
