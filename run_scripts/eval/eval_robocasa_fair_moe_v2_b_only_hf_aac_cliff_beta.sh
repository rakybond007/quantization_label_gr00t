#!/bin/bash
#SBATCH --job-name=eval_robocasa_fair_moe_v2_b_only_HF_60k_aac_cliff_entropy_xi1_N10_beta_sample_t_24t_50ep
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --partition=background
#SBATCH --array=0-7
#SBATCH --output=out/%A_%a-eval_robocasa_fair_moe_v2_b_only_hf_aac_beta.out
#SBATCH --error=out/%A_%a-eval_robocasa_fair_moe_v2_b_only_hf_aac_beta.err
#SBATCH --time=2-00:00:00
#SBATCH --comment="fair_moe_v2_b_only HF ckpt: head=moe_selective N=10 + AAC cliff (entropy xi=1) + Beta-sampled timestep schedule"
...
OUTPUT_BASE="$BASE_DIR/output/robocasa/fair_moe_v2_b_only_aac_cliff_beta_xi${AAC_XI}_N${N_SAMPLES}"
