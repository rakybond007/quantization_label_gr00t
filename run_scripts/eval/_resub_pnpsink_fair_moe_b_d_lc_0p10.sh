#!/bin/bash
#SBATCH --job-name=resub_PnPCounterToSink_fair_moe_b_d_lc_0p10_single_job_no_video_no_array_no_siblings
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --partition=background
#SBATCH --output=out/%j-resub_PnPCounterToSink_fair_moe_b_d_lc_0p10.out
#SBATCH --error=out/%j-resub_PnPCounterToSink_fair_moe_b_d_lc_0p10.err
#SBATCH --time=06:00:00
#SBATCH --comment="Single-job resub PnPCounterToSink for fair_moe_b_d_lc_0p10 (mujoco framebuffer workaround: --no_record_video)."
