#!/bin/bash
#SBATCH --job-name=eval_dexjoco_dual_arm_5tasks_baseline_60k_50ep_arr5_trial3_seed2
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --partition=background
#SBATCH --exclude=worker-node100
#SBATCH --array=0-4
#SBATCH --output=out/%A_%a-eval_dexjoco_dual_arm_baseline_60k_trial3.out
#SBATCH --error=out/%A_%a-eval_dexjoco_dual_arm_baseline_60k_trial3.err
...
OUTPUT_BASE="$BASE_DIR/output/dexjoco/dual_arm_multitask_baseline_60k_trial3"
