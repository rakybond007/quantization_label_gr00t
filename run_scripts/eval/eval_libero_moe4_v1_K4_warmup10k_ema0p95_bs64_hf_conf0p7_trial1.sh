#!/bin/bash
#SBATCH --job-name=eval_libero_moe4_v1_K4_ema0p95_HF_60k_conf0p7_gated_stochastic_trial1_4suite_10arr
#SBATCH --nodes=1
#SBATCH --gpus=1
...
OUTPUT_BASE="$BASE_DIR/output/libero/moe4_v1_K4_warmup10k_ema0p95_bs64_hf_conf0p7_trial1"
