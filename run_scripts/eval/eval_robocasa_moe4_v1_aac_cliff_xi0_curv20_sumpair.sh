#!/bin/bash
#SBATCH --job-name=eval_robocasa_moe4_v1_K4_b_only_no_metaq_HF_60k_aac_cliff_xi0_curv20_sumpair_m8_moe_selective_24t_50ep_arr8
#SBATCH --nodes=1
#SBATCH --gpus=1
...
OUTPUT_BASE="$BASE_DIR/output/robocasa/moe4_v1_b_only_no_metaq_aac_cliff_xi0_curv20_sumpair"
