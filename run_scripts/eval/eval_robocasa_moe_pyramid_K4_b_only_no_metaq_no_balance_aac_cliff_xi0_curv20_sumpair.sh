#!/bin/bash
#SBATCH --job-name=eval_robocasa_moe_pyramid_K4_raw16_m8_m4_m2_b_only_no_metaq_no_balance_60k_aac_cliff_xi0_curv20_sumpair_moe_selective_24t_50ep_arr8
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --partition=background
#SBATCH --exclude=worker-node100
#SBATCH --array=0-7
#SBATCH --output=out/%A_%a-eval_robocasa_moe_pyramid_K4_aac_cliff_xi0_curv20_sumpair.out
#SBATCH --error=out/%A_%a-eval_robocasa_moe_pyramid_K4_aac_cliff_xi0_curv20_sumpair.err
#SBATCH --time=2-00:00:00
#SBATCH --comment="robocasa MoE pyramid K=4 {raw16, merged8(2x), merged4(4x), merged2(8x)} @60k + AAC cliff head=moe_selective N=10 entropy xi=0 + curvature 2.0 main_sumpair."

set -u
CKPT_DIR="$HOME/multigpu_workspace/Isaac-GR00T/ckpt/robocasa/groot/groot_n1_5_bs64_moe_pyramid_K4_raw16_m8_m4_m2_b_only_no_metaq_no_balance/checkpoint-60000"
PORT=$((9960 + SLURM_ARRAY_TASK_ID))
N_EPISODES=50
N_SAMPLES=10

BASE_DIR="$HOME/multigpu_workspace/Isaac-GR00T"
CONDA_PATH="$HOME/miniconda3"
OUTPUT_BASE="$BASE_DIR/output/robocasa/moe_pyramid_K4_raw16_m8_m4_m2_b_only_no_metaq_no_balance_aac_cliff_xi0_curv20_sumpair"
