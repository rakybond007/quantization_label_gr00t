#!/bin/bash
#SBATCH --job-name=eval_libero_baseline
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --partition=background
#SBATCH --array=0-9
#SBATCH --output=out/%A_%a-eval_libero_baseline.out
#SBATCH --error=out/%A_%a-eval_libero_baseline.err
#SBATCH --time=2-00:00:00
#SBATCH --comment="Eval our libero baseline (60k) on 4 task suites x 10 tasks x 50 ep"
...
OUTPUT_BASE="$BASE_DIR/output/libero/baseline"
