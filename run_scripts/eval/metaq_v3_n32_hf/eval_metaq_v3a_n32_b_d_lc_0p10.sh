#!/bin/bash
#SBATCH --job-name=eval_robocasa_metaq_v3a_n32_K4_B_D_lc_0p10_HF_60k_as_is_24t_50ep_arr8_HFckpt
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --partition=background
#SBATCH --array=0-7
#SBATCH --output=out/%A_%a-eval_metaq_v3a_n32_b_d_lc_0p10.out
#SBATCH --error=out/%A_%a-eval_metaq_v3a_n32_b_d_lc_0p10.err
#SBATCH --time=2-00:00:00
#SBATCH --comment="metaq v3a (K=4 u32/c16/u16/c8) + n_meta_q=32 + B + D gamma=0.10 (HF) eval at 60k as_is."
