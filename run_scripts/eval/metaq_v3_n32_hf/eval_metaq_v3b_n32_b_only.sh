#!/bin/bash
#SBATCH --job-name=eval_robocasa_metaq_v3b_n32_K6_B_only_HF_60k_as_is_24t_50ep_arr8_HFckpt
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --partition=background
#SBATCH --array=0-7
#SBATCH --output=out/%A_%a-eval_metaq_v3b_n32_b_only.out
#SBATCH --error=out/%A_%a-eval_metaq_v3b_n32_b_only.err
#SBATCH --time=2-00:00:00
#SBATCH --comment="metaq v3b (K=6 u32/c16/u16/c8/u8/c4) + n_meta_q=32 + B only (HF) eval at 60k as_is."

set -u
HF_REPO=prehj/GR00T-N1.5-robocasa-metaq-v3b-n32-K6-b-only-60k
...
OUTPUT_BASE="$BASE_DIR/output/robocasa/metaq_v3b_n32_b_only_as_is"
