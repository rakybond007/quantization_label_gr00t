#!/bin/bash
#SBATCH --job-name=eval_robocasa_fair_moe_v2_b_only_HF_60k_as_is_router_pick_beta_sample_t_only_no_aac_cliff_24t_50ep
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --partition=background
#SBATCH --array=0-7
#SBATCH --output=out/%A_%a-eval_robocasa_fair_moe_v2_b_only_hf_as_is_beta.out
#SBATCH --error=out/%A_%a-eval_robocasa_fair_moe_v2_b_only_hf_as_is_beta.err
#SBATCH --time=2-00:00:00
#SBATCH --comment="fair_moe_v2_b_only HF ckpt: as_is router pick + Beta-sampled timestep schedule (NO AAC cliff). Isolates the Beta-sampling effect from the AAC variant."
