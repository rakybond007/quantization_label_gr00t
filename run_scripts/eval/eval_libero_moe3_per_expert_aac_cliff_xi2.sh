#!/bin/bash
#SBATCH --job-name=eval_libero_moe3_per_expert_main_m8_m4_with_aac_cliff_entropy_xi2_60k_chkpt_less_compress
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --partition=background
#SBATCH --array=0-9
#SBATCH --output=out/%A_%a-eval_libero_moe3_aac_cliff_xi2.out
#SBATCH --error=out/%A_%a-eval_libero_moe3_aac_cliff_xi2.err
#SBATCH --time=1-00:00:00
#SBATCH --comment="Libero MoE3 + AAC cliff xi=2 (less aggressive prefix compression than xi=1)"

set -u
HEAD=moe_selective; N=10; MODE=aac_cliff; AAC_XI=2
...
echo "[i] Array $SLURM_ARRAY_TASK_ID | libero MoE3 $MODE xi=$AAC_XI"
