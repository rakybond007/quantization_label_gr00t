...
CKPT_PATH="$CKPT_DIR/groot_n1_5_libero/checkpoint-$CKPT_STEP"
...
for TASK_NAME in "${TASK_NAMES[@]}"; do
    OUTPUT_DIR="$BASE_DIR/output/groot/$TASK_NAME/groot_n1_5_libero-debug/$CKPT_STEP"
    mkdir -p "$OUTPUT_DIR"
