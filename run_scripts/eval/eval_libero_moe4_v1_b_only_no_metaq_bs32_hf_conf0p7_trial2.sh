#!/bin/bash
#SBATCH --job-name=eval_libero_moe4_v1_b_only_no_metaq_bs32_HF_60k_conf0p7_gated_trial2_4suite_10arr
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --partition=background
#SBATCH --exclude=worker-node100
#SBATCH --array=0-9
#SBATCH --output=out/%A_%a-eval_libero_moe4_v1_b_only_no_metaq_bs32_trial2.out
#SBATCH --error=out/%A_%a-eval_libero_moe4_v1_b_only_no_metaq_bs32_trial2.err
#SBATCH --time=1-00:00:00
#SBATCH --comment="libero MoE4 v1 (K=4 u16/c8/c4/n8) + B only + no metaq, bs32 TRIAL2 HF ckpt @60k, as_is router pick (avg_pool), all 4 suites."

set -u
HF_REPO=prehj/GR00T-N1.5-libero-moe4-v1-K4-b-only-no-metaq-bs32-trial2-60k
PORT=$((9420 + SLURM_ARRAY_TASK_ID))
...
OUTPUT_BASE="$BASE_DIR/output/libero/moe4_v1_b_only_no_metaq_bs32_hf_conf0p7_trial2"
