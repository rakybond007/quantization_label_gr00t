#!/bin/bash
#SBATCH --job-name=eval_robocasa_baseline_aac_cliff_entropy_xi1_main_n_main_sumpair_60k_24t_50ep_arr8
#SBATCH --nodes=1
#SBATCH --gpus=1
...
#SBATCH --comment="Robocasa BASELINE (non-MoE) + AAC cliff (entropy, xi=1) via head=main_n + main_sumpair. Inference-time sum-pair compression on the base model (no m8/MoE). 24 tasks x 50 ep."
