...
#SBATCH --array=0-7
#SBATCH --output=out/%A_%a-eval_robocasa_router_qformer_1q_balance_conf0p7.out
#SBATCH --error=out/%A_%a-eval_robocasa_router_qformer_1q_balance_conf0p7.err
...
OUTPUT_BASE="$BASE_DIR/output/robocasa/moe4_v1_b_only_no_metaq_router_qformer_1q_balance_conf0p7"
