#!/bin/bash
#SBATCH --job-name=eval_dexjoco_dual_arm_5tasks_baseline_50k_50ep_arr5
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --partition=background
#SBATCH --exclude=worker-node100
#SBATCH --array=0-4
#SBATCH --output=out/%A_%a-eval_dexjoco_dual_arm_baseline_50k.out
#SBATCH --error=out/%A_%a-eval_dexjoco_dual_arm_baseline_50k.err
#SBATCH --comment="DexJoCo dual-arm 5-task baseline GR00T-N1.5 @50k, 50 ep/task."
...
CKPT="$BASE_DIR/ckpt/dexjoco/groot/groot_n1_5_bs64_dual_arm_multitask_baseline/checkpoint-50000"
CONFIG="$DEXJOCO_REPO/configs/rand_obj/$TASK.yaml"
OUTPUT_BASE="$BASE_DIR/output/dexjoco/dual_arm_multitask_baseline_50k"
