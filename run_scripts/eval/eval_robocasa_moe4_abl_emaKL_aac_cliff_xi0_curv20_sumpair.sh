#!/bin/bash
#SBATCH --job-name=eval_robocasa_moe4_abl_emaKL_60k_aac_cliff_xi0_curv20_sumpair_m8_moe_selective_24t_50ep_arr8
#SBATCH --nodes=1
#SBATCH --gpus=1
...
#SBATCH --comment="robocasa MoE4 v1 (K=4, fair_moe) + AAC cliff (head=moe_selective N=10, entropy, xi=0 + curvature 2.0, compress_src=main_sumpair trained decoder). Matches baseline+aac best (xi0+curv2.0) for breakwater comparison."

set -u
HF_REPO=LOCAL
PORT=$((9890 + SLURM_ARRAY_TASK_ID))
N_EPISODES=50
N_SAMPLES=10

BASE_DIR="$HOME/multigpu_workspace/Isaac-GR00T"
CONDA_PATH="$HOME/miniconda3"
CKPT="/sjw_alinlab2/home/jimin/workspace/ckpt/robocasa/groot/groot_n1_5_bs64_moe4_abl_emaKL/checkpoint-60000"
OUTPUT_BASE="$BASE_DIR/output/robocasa/moe4_abl_emaKL_aac_cliff_xi0_curv20_sumpair"
