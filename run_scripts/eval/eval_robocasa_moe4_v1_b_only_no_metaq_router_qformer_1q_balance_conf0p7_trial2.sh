#!/bin/bash
#SBATCH --job-name=eval_robocasa_moe4_v1_b_only_no_metaq_router_qformer_1q_balance_conf0p7_HF_60k_24t_50ep_arr8
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --partition=background
#SBATCH --exclude=worker-node100
#SBATCH --array=0-7
#SBATCH --output=out/%A_%a-eval_robocasa_router_qformer_1q_balance_conf0p7_trial2.out
#SBATCH --error=out/%A_%a-eval_robocasa_router_qformer_1q_balance_conf0p7_trial2.err
#SBATCH --time=2-00:00:00
#SBATCH --comment="robocasa MoE4 v1 K=4 b_only no_metaq balance ON EMA-KL (router=qformer_1q (1 learnable token)) + conf0p7 gated stochastic. Router-input ablation."
...
OUTPUT_BASE="$BASE_DIR/output/robocasa/moe4_v1_b_only_no_metaq_router_qformer_1q_balance_conf0p7_trial2"
