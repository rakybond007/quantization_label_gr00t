#!/bin/bash
#SBATCH --job-name=eval_libero_fair_moe_v3a_K4_b_only_bs32_HF_60k_as_is_router_pick_4suite_10arr_50ep
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --partition=background
#SBATCH --array=0-9
#SBATCH --output=out/%A_%a-eval_libero_fair_moe_v3a_K4_b_only_bs32.out
#SBATCH --error=out/%A_%a-eval_libero_fair_moe_v3a_K4_b_only_bs32.err
#SBATCH --time=1-00:00:00
#SBATCH --comment="libero fair_moe v3a (K=4 u32/c16-from-32/u16/c8-from-16) + B only, bs32 HF ckpt @60k, as_is router pick, all 4 suites. v3 serve."

set -u
HF_REPO=prehj/GR00T-N1.5-libero-fair-moe-v3a-K4-b-only-bs32-60k
...
OUTPUT_BASE="$BASE_DIR/output/libero/fair_moe_v3a_K4_b_only_bs32_hf_as_is"
...
"$CONDA_PATH/envs/gr00t/bin/python" "$BASE_DIR/scripts/serve_policy_fair_moe_v3.py" \
