#!/bin/bash
#SBATCH --job-name=eval_libero_moe4_v1_K4_b_only_no_metaq_bs32_HF_60k_as_is_m8replan2_4suite_10arr_50ep
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --partition=background
#SBATCH --array=0-9
#SBATCH --output=out/%A_%a-eval_libero_moe4_v1_b_only_no_metaq_bs32_m8replan2.out
#SBATCH --error=out/%A_%a-eval_libero_moe4_v1_b_only_no_metaq_bs32_m8replan2.err
#SBATCH --time=1-00:00:00
#SBATCH --comment="libero MoE4 v1 bs32 (existing 60k) as_is, m8 replan_steps=2 (was 3). all 4 suites."
...
OUTPUT_BASE="$BASE_DIR/output/libero/moe4_v1_b_only_no_metaq_bs32_hf_as_is_m8replan2"
