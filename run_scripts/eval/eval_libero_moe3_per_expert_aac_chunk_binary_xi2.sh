#!/bin/bash
#SBATCH --job-name=eval_libero_moe3_per_expert_main_m8_m4_with_aac_chunk_binary_entropy_xi2_60k_chkpt_compression_threshold_sweep
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --partition=background
#SBATCH --array=0-9
#SBATCH --output=out/%A_%a-eval_libero_moe3_aac_chunk_binary_xi2.out
#SBATCH --error=out/%A_%a-eval_libero_moe3_aac_chunk_binary_xi2.err
#SBATCH --time=1-00:00:00
#SBATCH --comment="Libero MoE3 + aac_chunk_binary xi=2 (compression threshold sweep)"

set -u
HEAD=moe_selective; N=10; MODE=aac_chunk_binary; AAC_XI=2
PORT=$((9000 + 940 + SLURM_ARRAY_TASK_ID))
