#!/bin/bash
#SBATCH --job-name=eval_robocasa_moe4_v1_K4_b_only_no_metaq_router_vl_self_attn_HF_60k_chkpt_as_is_24t_50ep_arr8
#SBATCH --nodes=1
#SBATCH --gpus=1
...
#SBATCH --comment="robocasa MoE4 v1 (K=4 u16/c8/c4/n8) + B only + no metaq HF ckpt @60k, as_is router pick."
...
OUTPUT_BASE="$BASE_DIR/output/robocasa/moe4_v1_b_only_no_metaq_router_vl_self_attn_hf_as_is"
