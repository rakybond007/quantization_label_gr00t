#!/bin/bash
#SBATCH --job-name=eval_dexjoco_single_arm_baseline_compress_K2_60k_6t_50ep_arr6
#SBATCH --nodes=1
#SBATCH --gpus=1
...
PORT=$((10180 + SLURM_ARRAY_TASK_ID))
N_EPISODES=50
...
OUTPUT_BASE="$BASE_DIR/output/dexjoco/single_arm_multitask_baseline_compress_K2"
