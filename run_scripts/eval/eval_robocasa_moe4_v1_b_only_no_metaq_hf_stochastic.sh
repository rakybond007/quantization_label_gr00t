#!/bin/bash
#SBATCH --job-name=eval_robocasa_moe4_v1_K4_b_only_no_metaq_HF_60k_chkpt_stochastic_router_pick_24t_50ep_arr8
#SBATCH --nodes=1
#SBATCH --gpus=1
...
#SBATCH --comment="robocasa MoE4 v1 (K=4 u16/c8/c4/n8) + B only + no metaq HF ckpt @60k, STOCHASTIC router pick."
...
OUTPUT_BASE="$BASE_DIR/output/robocasa/moe4_v1_b_only_no_metaq_hf_stochastic"
