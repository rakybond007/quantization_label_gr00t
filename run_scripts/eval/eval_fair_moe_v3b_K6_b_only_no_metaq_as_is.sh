#!/bin/bash
#SBATCH --job-name=eval_robocasa_fair_moe_v3b_K6_b_only_no_metaq_local_60k_chkpt_as_is_router_pick_24t_50ep_arr8
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --partition=background
#SBATCH --array=0-7
#SBATCH --output=out/%A_%a-eval_fair_moe_v3b_K6_b_only_no_metaq.out
#SBATCH --error=out/%A_%a-eval_fair_moe_v3b_K6_b_only_no_metaq.err
#SBATCH --time=2-00:00:00
#SBATCH --comment="fair_moe v3b (K=6 u32/c16/u16/c8/u8/c4) + B only + no metaq (local 319637) eval at 60k, as_is router pick."

set -u
PORT=$((9990 + SLURM_ARRAY_TASK_ID))
N_EPISODES=50

BASE_DIR="$HOME/multigpu_workspace/Isaac-GR00T"
CONDA_PATH="$HOME/miniconda3"
CKPT="$BASE_DIR/ckpt/robocasa/groot/groot_n1_5_bs64_fair_moe_v3b_b_only/checkpoint-60000"
OUTPUT_BASE="$BASE_DIR/output/robocasa/fair_moe_v3b_K6_b_only_no_metaq_local_as_is"
...
PYTHONUNBUFFERED=1 "$CONDA_PATH/envs/gr00t/bin/python" -u "$BASE_DIR/scripts/inference_service_fair_moe_v3.py" --server \
