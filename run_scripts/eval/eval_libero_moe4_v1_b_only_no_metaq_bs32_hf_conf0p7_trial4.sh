#!/bin/bash
#SBATCH --job-name=eval_libero_moe4_v1_b_only_no_metaq_bs32_HF_60k_conf0p7_gated_trial4_4suite_10arr
#SBATCH --nodes=1
#SBATCH --gpus=1
...
set -u
HF_REPO=prehj/GR00T-N1.5-libero-moe4-v1-K4-b-only-no-metaq-bs32-trial4-60k
PORT=$((9480 + SLURM_ARRAY_TASK_ID))
...
OUTPUT_BASE="$BASE_DIR/output/libero/moe4_v1_b_only_no_metaq_bs32_hf_conf0p7_trial4"
