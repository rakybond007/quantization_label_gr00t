#!/bin/bash
#SBATCH --job-name=eval_dexjoco_single_arm_multitask_6tasks_baseline_30k_50ep_arr6
#SBATCH --nodes=1
#SBATCH --gpus=1
...
#SBATCH --time=4:00:00
#SBATCH --comment="DexJoCo single-arm 6-task baseline GR00T-N1.5 @30k, 50 ep/task."
...
CKPT="$BASE_DIR/ckpt/dexjoco/groot/groot_n1_5_bs64_single_arm_multitask_baseline/checkpoint-30000"
CONFIG="$DEXJOCO_REPO/configs/rand_obj/$TASK.yaml"
OUTPUT_BASE="$BASE_DIR/output/dexjoco/single_arm_multitask_baseline_30k"
