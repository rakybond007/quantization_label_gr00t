#!/bin/bash
#SBATCH --job-name=eval_robocasa_moe4_per_expert_metaq_mean_sq_balance_as_is_60k_chkpt
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --partition=background
#SBATCH --array=0-7
#SBATCH --output=out/%A_%a-eval_robocasa_metaq_mean_sq_balance.out
#SBATCH --error=out/%A_%a-eval_robocasa_metaq_mean_sq_balance.err
#SBATCH --time=2-00:00:00
#SBATCH --comment="Metaq ablation mean_sq_balance eval (HF: prehj/gr00t-n1.5-robocasa-metaq-mean_sq_balance)"
...
CKPT="$("$CONDA_PATH/envs/gr00t/bin/python" -c "from huggingface_hub import snapshot_download; print(snapshot_download('prehj/gr00t-n1.5-robocasa-metaq-mean_sq_balance', repo_type='model'))")"
OUTPUT_BASE="$BASE_DIR/output/robocasa/moe4_per_expert_metaq_mean_sq_balance_as_is"
