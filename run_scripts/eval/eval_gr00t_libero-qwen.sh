...
for TASK_NAME in "${TASK_NAMES[@]}"; do
    OUTPUT_DIR="$BASE_DIR/output/groot/$TASK_NAME/groot_n1_5_libero_qwen-12/$CKPT_STEP"
    mkdir -p "$OUTPUT_DIR"
    "$CONDA_PREFIX"/envs/libero/bin/python Isaac-GR00T/gr00t/eval/libero/eval_taskwise_gr00t.py \
        ...
        --args.port=824$SLURM_ARRAY_TASK_ID \
