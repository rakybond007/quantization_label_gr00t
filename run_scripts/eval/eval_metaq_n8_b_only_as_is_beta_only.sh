#!/bin/bash
#SBATCH --job-name=eval_robocasa_metaq_n8_b_only_60k_chkpt_as_is_beta_sample_t_only_24t_50ep_arr8_local_ckpt
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --partition=background
#SBATCH --array=0-7
#SBATCH --output=out/%A_%a-eval_robocasa_metaq_n8_b_only_as_is_beta_only.out
#SBATCH --error=out/%A_%a-eval_robocasa_metaq_n8_b_only_as_is_beta_only.err
#SBATCH --time=2-00:00:00
#SBATCH --comment="metaq + [B] only (local 318766) eval at 60k, as_is router pick + Beta-sampled t."
...
OUTPUT_BASE="$BASE_DIR/output/robocasa/metaq_n8_b_only_as_is_beta_only"
