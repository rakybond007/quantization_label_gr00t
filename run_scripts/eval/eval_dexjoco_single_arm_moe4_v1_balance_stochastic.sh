#!/bin/bash
#SBATCH --job-name=eval_dexjoco_single_arm_multitask_moe4_v1_balance_60k_stochastic_50ep_arr6
#SBATCH --nodes=1
#SBATCH --gpus=1
...
PORT=$((10200 + SLURM_ARRAY_TASK_ID))
N_EPISODES=50
...
OUTPUT_BASE="$BASE_DIR/output/dexjoco/single_arm_multitask_moe4_v1_balance_60k_stochastic"
