#!/bin/bash
#SBATCH --job-name=eval_robocasa_moe4_v1_K4_no_balance_HF_60k_aac_cliff_xi0_curv20_sumpair_moe_selective_24t_50ep_arr8
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --partition=background
#SBATCH --array=0-7
#SBATCH --output=out/%A_%a-eval_robocasa_moe4_v1_aac_cliff_xi0_curv20_sumpair.out
#SBATCH --error=out/%A_%a-eval_robocasa_moe4_v1_aac_cliff_xi0_curv20_sumpair.err
#SBATCH --time=2-00:00:00
#SBATCH --comment="robocasa MoE4 v1 K=4 NO_BALANCE + AAC cliff (head=moe_selective N=10, entropy, xi=0 + curvature 2.0, compress_src=main_sumpair trained decoder). Matches baseline+aac best (xi0+curv2.0) for breakwater comparison."

set -u
HF_REPO=prehj/GR00T-N1.5-robocasa-moe4-v1-K4-b-only-no-metaq-no-balance-60k
...
OUTPUT_BASE="$BASE_DIR/output/robocasa/moe4_v1_K4_b_only_no_metaq_no_balance_aac_cliff_xi0_curv20_sumpair"
