#!/bin/bash
#SBATCH --job-name=eval_robocasa_moe4_compaware_lambda_c_0p1_as_is_60k_chkpt
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --partition=background
#SBATCH --array=0-7
#SBATCH --output=out/%A_%a-eval_robocasa_moe4_compaware_as_is.out
#SBATCH --error=out/%A_%a-eval_robocasa_moe4_compaware_as_is.err
#SBATCH --time=2-00:00:00
#SBATCH --comment="Robocasa MoE4 (main+m8+m4+n8) compression-aware lambda_c=0.1 — as_is eval"

set -u

PORT=$((9600 + SLURM_ARRAY_TASK_ID))
N_EPISODES=50

BASE_DIR="$HOME/multigpu_workspace/Isaac-GR00T"
CONDA_PATH="$HOME/miniconda3"
CKPT="$BASE_DIR/ckpt/robocasa/groot/groot_n1_5_bs64_moe4_per_expert_body_compression_aware_lambda_c_0p1/checkpoint-60000"
OUTPUT_BASE="$BASE_DIR/output/robocasa/moe4_compaware_lambda_c_0p1_as_is"
...
echo "[i] Array $SLURM_ARRAY_TASK_ID | MoE4 compaware as_is | port=$PORT"
