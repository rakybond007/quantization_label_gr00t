#!/bin/bash
#SBATCH --job-name=eval_robocasa_moe4_per_expert_metaq_no_length_cost_as_is_60k_chkpt
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --partition=background
#SBATCH --array=0-7
#SBATCH --output=out/%A_%a-eval_robocasa_metaq_no_length_cost.out
#SBATCH --error=out/%A_%a-eval_robocasa_metaq_no_length_cost.err
#SBATCH --time=2-00:00:00
#SBATCH --comment="Metaq no_length_cost eval at checkpoint-60000"
