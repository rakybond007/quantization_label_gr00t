#!/bin/bash
#SBATCH --job-name=eval_robocasa_moe4_v1_K4_b_only_no_metaq_router_instr_end_HF_60k_trial2_seed196_24t_50ep_arr8
#SBATCH --nodes=1
#SBATCH --gpus=1
...
#SBATCH --comment="robocasa MoE4 v1 (K=4 u16/c8/c4/n8) + B only + no metaq HF ckpt @60k, trial2 argmax (seed 196)."

set -u
HF_REPO=prehj/GR00T-N1.5-robocasa-moe4-v1-K4-b-only-no-metaq-router-instr-end-60k
PORT=$((10010 + SLURM_ARRAY_TASK_ID))
N_EPISODES=50
...
OUTPUT_BASE="$BASE_DIR/output/robocasa/moe4_v1_b_only_no_metaq_router_instr_end_hf_trial2"
