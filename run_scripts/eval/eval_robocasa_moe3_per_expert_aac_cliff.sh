#!/bin/bash
#SBATCH --job-name=eval_robocasa_moe3_per_expert_main_m8_m4_with_aac_cliff_entropy_xi1_60k_chkpt
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --partition=background
#SBATCH --array=0-7
#SBATCH --output=out/%A_%a-eval_robocasa_moe3_aac_cliff.out
#SBATCH --error=out/%A_%a-eval_robocasa_moe3_aac_cliff.err
#SBATCH --time=2-00:00:00
#SBATCH --comment="Robocasa MoE3 per_expert eval + AAC cliff (entropy score, xi=1, head=moe_selective N=10)"
...
PORT=$((9750 + SLURM_ARRAY_TASK_ID))
N_EPISODES=50

BASE_DIR="$HOME/multigpu_workspace/Isaac-GR00T"
CONDA_PATH="$HOME/miniconda3"
CKPT="$BASE_DIR/ckpt/robocasa/groot/groot_n1_5_bs64_moe3_per_expert_body/checkpoint-60000"
OUTPUT_BASE="$BASE_DIR/output/robocasa/moe3_per_expert_aac_cliff_xi${AAC_XI}"
...
echo "[i] Array $SLURM_ARRAY_TASK_ID | robocasa MoE3 + AAC cliff (xi=$AAC_XI, N=$N_SAMPLES) | port=$PORT"
