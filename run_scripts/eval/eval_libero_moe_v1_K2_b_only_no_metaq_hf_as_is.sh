#!/bin/bash
#SBATCH --job-name=eval_libero_moe_v1_K2_raw16_m8_b_only_HF_60k_as_is_4suite_10arr_50ep
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --partition=background
#SBATCH --array=0-9
#SBATCH --output=out/%A_%a-eval_libero_moe_v1_K2_b_only.out
#SBATCH --error=out/%A_%a-eval_libero_moe_v1_K2_b_only.err
#SBATCH --time=1-00:00:00
#SBATCH --comment="libero MoE v1 K=2 (raw16, merged8) b-only no-metaq HF @60k, head=moe as_is, 4 suites."

set -u
HF_REPO=prehj/GR00T-N1.5-libero-moe-v1-K2-raw16-merged8-b-only-no-metaq-60k
...
OUTPUT_BASE="$BASE_DIR/output/libero/moe_v1_K2_raw16_m8_b_only_no_metaq_hf_as_is"
