#!/bin/bash
#SBATCH --job-name=eval_robocasa_metaq_v3b_n32_K6_B_D_lc_0p10_HF_60k_seed196_24t_50ep_arr8_seed_variance_probe
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --partition=background
#SBATCH --array=0-7
#SBATCH --output=out/%A_%a-eval_metaq_v3b_n32_b_d_seed196.out
#SBATCH --error=out/%A_%a-eval_metaq_v3b_n32_b_d_seed196.err
#SBATCH --time=2-00:00:00
#SBATCH --comment="metaq v3b (K=6) + B + D gamma=0.10 + n_meta_q=32 (HF, best so far) @ 60k — seed 196 (seed-variance probe)."

set -u

PORT=$((10110 + SLURM_ARRAY_TASK_ID))
N_EPISODES=50

BASE_DIR="$HOME/multigpu_workspace/Isaac-GR00T"
CONDA_PATH="$HOME/miniconda3"
CKPT="$("$CONDA_PATH/envs/gr00t/bin/python" -c "from huggingface_hub import snapshot_download; print(snapshot_download('prehj/GR00T-N1.5-robocasa-metaq-v3b-n32-K6-b-d-lc-0p10-60k', repo_type='model'))")"
OUTPUT_BASE="$BASE_DIR/output/robocasa/metaq_v3b_n32_b_d_lc_0p10_as_is_seed196"
