#!/bin/bash
#SBATCH --job-name=eval_dexjoco_single_arm_multitask_6tasks_moe4_v1_no_balance_60k_as_is_50ep_arr6
#SBATCH --nodes=1
#SBATCH --gpus=1
...
#SBATCH --time=4:00:00
#SBATCH --comment="DexJoCo single-arm 6-task MoE4 v1 (no balance) router pick (head=moe) @60k, 50 ep/task."
...
OUTPUT_BASE="$BASE_DIR/output/dexjoco/single_arm_multitask_moe4_v1_no_balance_60k_as_is"
