...
$HOME/miniconda3/envs/quant_gate_eval/bin/python -u scripts/train_gate_module.py \
  ...
  --epochs 900 --bs 256 --lr 3e-4 --num-workers 8 \
  --wandb "$(basename $MODEL_OUTPUT_DIR)" --task-emb "/rlwrld-unified-checkpoints/hojin2/checkpoints/gate_distill_robocasa_cosmos_v1/robocasa_task_embeddings.npz"
