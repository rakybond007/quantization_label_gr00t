"""robocasa 문항 v21 후보 = **v10 + GUIDANCE 다시 씀 + C 좁힘.** 라벨 아직 없다.
...
GUIDANCE = (
    ...
    "where the arm is only working a fitting that is anchored in place -- a button or "
    "switch pressed, a knob or tap turned, a door pushed shut. There a longer step just "
    "presses or turns a little harder and nothing is lost.\n\n"
...
_AXES = (
    ...
    "   it closes?\n"
    "C) Is the arm just working a fitting that is anchored in place -- pressing a button\n"
    "   or switch, turning a knob or tap, pushing a door or drawer shut -- and not\n"
    "   something it has to keep hold of while it travels, the way a handle is held on\n"
    "   to and pulled to swing a door or drawer open?\n"
    ...
    "   not yet opened, the object not yet taking its own weight, still coming down\n"
    "   onto the spot it must end up on?\n")
