"""robocasa 문항 v20 후보 = **v10 + GUIDANCE 다시 씀 + C 좁힘.** 라벨 아직 없다.
...
GUIDANCE = (
    ...
    "where whatever is being worked on is held by its own hinge, rail or mount, because "
    "there the mechanism takes up going a little too far instead of the arm paying for it.\n\n"
...
_AXES = (
    ...
    "   it closes?\n"
    "C) Is whatever the arm is working on held by the furniture or appliance itself --\n"
    "   a door or drawer on its hinge or rail, a knob, tap, switch, button or lever on\n"
    "   its mount -- so that going a little too far or a little off line is taken up by\n"
    "   the mechanism, and not paid for by losing hold of what the gripper has?\n"
