...
out=open(f"{BASE}/output/_gate_distill/luna_real_full/labels_api_none.jsonl","w")
...
for i in range(0,len(sample),6):
    ...
    body=json.dumps({"model":"gpt-5.6-luna","max_completion_tokens":64,"reasoning_effort":"none",
