> **Branch `action-quantization-gate-v2` — quantizability-gated action quantization.**
> This fork adds a VLM-judged gate that decides, per action chunk, whether the next
> ~1 s of motion can be temporally compressed (K2). Start at
> **[`vlm_gate/README.md`](vlm_gate/README.md)** for results, the labelling protocol,
> pretrained gates on the Hub, and how to attach your own policy on top of the
> gate's confidence. Everything below is the upstream NVIDIA Isaac-GR00T README.
