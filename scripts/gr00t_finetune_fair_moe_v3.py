...
from gr00t.model.gr00t_n1_fair_moe_v3 import GR00T_N1_5_FairMoeV3 as GR00T_N1_5, GR00T_N1_5_FairMoeV3_Config as GR00T_N1_5_Config
    ...
    if config.use_merged_4_head or config.use_native_8_head or config.use_moe_routing:
        ...
        if ah.use_moe_routing:
            ...
            if ah.moe_routing_mode == "single_pick":
                ...
                assert ah.use_native_8_head, "v3 fork requires --use-native-8-head (n8 decoder used for c8)"
